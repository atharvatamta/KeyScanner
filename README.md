...
<img width="1295" height="1497" alt="image" src="https://github.com/user-attachments/assets/899a1628-b196-4625-b770-8ea952450894" />




A Node.js security research CLI that scans a website's frontend JavaScript (linked and inline) — and, optionally, public GitHub source — for accidentally committed API keys and secrets. It **detects and reports** exposed credentials so they can be rotated and remediated; it never authenticates with, validates, or otherwise uses any key it finds. Think of it as a focused, browser facing companion to tools like gitleaks or TruffleHog.
...
```bash
git clone https://github.com/atharvatamta/KeyScanner
cd keyscanner
npm install
npm install -g .
```
